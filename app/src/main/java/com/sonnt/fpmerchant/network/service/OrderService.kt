...
import com.sonnt.fpmerchant.network.dto.response.GetMerchantDoneOrdersResponse
...
interface OrderService {
    ...
    @GET("merchant/order/done-orders-in-day")
    suspend fun getDoneOrders(): Response<GetMerchantDoneOrdersResponse>
